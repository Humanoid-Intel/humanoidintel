...
const HUMANOID_SPECIFIC = /humanoid|bipedal|figure ai|optimus|digit\b|atlas\b|phoenix|apollo\b|neo beta|unitree|boston dynamics|agility robotics|apptronik|sanctuary ai|1x technologies|neura robotics|fourier intelligence|agibot|kepler robot|physical intelligence|clone robotics|skild|galbot|leju|ubtech|astribot|sunday robot|wandercraft|enchanted tools|mentee|flexion.*robot|dyna robotics|persona ai|android robot|loco.manipul|whole.body loco|dexterous hand|dexterous manipulation|bimanual|teleoperat|humanoid locomotion|humanoid manipulation|bipedal locomotion|humanoid control|walking robot|standing robot|balance control.*robot|robot.*balance|\bexoskeleton[s]?\b|human.like robot|bipedal walking|walking biped|robot foundation model|vision.language.action|\bvla\b|generalist robot|\bpi zero\b|π0|lerobot/i
